...
// BindingMany adds BindMany method to Binding. BindingMany is similar with Bind,
...
type BindingMany interface {
	Name() string
	BindMany(req *http.Request, uriParams map[string][]string, body io.Reader, obj any) error
}
